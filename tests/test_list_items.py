...
Drives tools_search.list_items against a real in-memory Database so the tool's
...
class TestListItemsTool(unittest.TestCase):
    ...
    def test_response_shape_and_paging(self):
        resp = tools_search.list_items(item_type="document", namespace="proj", limit=2, offset=2)
