...
_COMPACT_DESCRIPTIONS: dict[str, str] = {
    ...
    "store_document":   "Save long-form content (specs, docs, code). Upsert by namespace+title; response may include a 'similar' list of near-duplicates to review.",
    "store_knowledge":  "Save a single atomic fact or decision. Upsert by namespace+subject; a different fact supersedes rather than overwrites, keeping the old one as history (see fact_history). Response may include a 'similar' list of near-duplicates.",
    "store_note":       "Save informal or rough content. Upsert by namespace+title; response may include a 'similar' list of near-duplicates to review.",
